$( "#CircleForm" ).validate({
    // Add validation rules if needed here
  });
  ...
  function displayHypotenuse() {
      ...
      if ($("#CircleForm").valid()) {
          ...
          var leg1; // string representation of leg1
          var leg1fp; // floating point value of leg1
          var leg2; // string representation of leg2
          var leg2fp; // floating point value of leg2
